      ...
      <div className={`${styles.hero}`}>
        ...
        <div className={styles.heroContent}>
          <h1 className={`${styles.heroHeadline}`}>
            <span className="text-zinc-50">Elevate</span> Your{" "}
            <span className="text-zinc-50">Business</span> with Our Digital
        ...
        <div className={styles.heroImage}>
          {/* <div className="text-center font-bold">
               <h1 className="text-white mb-4 text-lg">INDUSTRIES WE SERVE</h1>
          </div> */}
          <Carousel
            autoPlay
            interval={3000}
