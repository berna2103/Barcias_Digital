...
const PricingSection = () => {
    return (
        ...
        <div className="w-full z-30 pt-20 md:w-10/12 lg:w-8/12 xl:w-7/12 2xl:w-6/12 text-center text-zinc-50">
            <h2 className="text-4xl font-bold mb-4 md:mb-5">We offer great pricing plans for everyone.</h2>
            <hr className="w-1/2 mx-auto border-t border-gray-400 mb-5 xl:mb-9" />
        </div>
        </div>
        </div>
